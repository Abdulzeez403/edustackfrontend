...
import { IRole, Url } from "../../types";
import { TableComponent } from "../../components/table/datatable";
import { AccountantForm } from "../form/create";
import { RoleDemoData } from "@/app/data";





const AccountantTablePage: React.FC<{ data?: IRole[] }> = ({ data }) => {
...
export default AccountantTablePage;